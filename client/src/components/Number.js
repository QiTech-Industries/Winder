...
const Number = ({ onChange, value, unit, label, tooltip }) => {
    value = parseFloat(value);
    return (
        <div class='w-full'>
            <Label tooltip={tooltip} label={label} />
            <div class="flex h-10">
                <input onChange={e => onChange(e.target.value)} type="number" value={value} maxlength="5" class="pl-3 py-2 rounded-l w-full text-left border-t border-b border-l border-gray-400 focus:outline-none" />
